...
function(e, t, s) {
    ...
    !e.DUOSHUO) {
        ...
        et.replybox = function(e) {
            ...
            e.options.use_smilies && (t += '<div class="ywz-wrapper ds-toolbar-buttons" id="ywz-wrapper"><div class="biaoqing_box" id="biaoqing_box"><a>(⌒▽⌒)</a><a>（￣▽￣）</a><a>(=・ω・=)</a><a>(｀・ω・&acute;)</a><a>(〜￣△￣)〜</a><a>(･∀･)</a><a>(&deg;∀&deg;)ﾉ</a><a>(￣3￣)</a><a>╮(￣▽￣)╭</a><a>( &acute;_ゝ｀)</a><a>←_←</a><a>→_→</a><a>(&lt;_&lt;)</a><a>(&gt;_&gt;)</a><a>(;&not;_&not;)</a><a>(&quot;▔□▔)/</a><a>(ﾟДﾟ≡ﾟдﾟ)!?</a><a>Σ(ﾟдﾟ;)</a><a>Σ( ￣□￣||)</a><a>(&acute;；ω；`)</a><a>（/TДT)/</a><a>(^・ω・^ )</a><a>(｡･ω･｡)</a><a>(●￣(ｴ)￣●)</a><a>ε=ε=(ノ≧∇≦)ノ</a><a>(&acute;･_･`)</a><a>(-_-#)</a><a>（￣へ￣）</a><a>(￣ε(#￣) Σ</a><a>ヽ(`Д&acute;)ﾉ</a><a>(╯&deg;口&deg;)╯(┴—┴</a><a>（#-_-)┯━┯</a><a>_(:3」∠)_</a><a>─=≡Σ((( つ•̀ω•́)つ</a><a>(ಥ_ಥ)</a><a>(๑•̀ㅂ•́)و✧  (8</a><a>(๑╹∀╹๑)</a><a>눈_눈</a></div><a class="ywz" id="ymz" target="_blank" style="text-decoration: none;">(・ω・) 颜文字</a></div>'),
